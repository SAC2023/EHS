...
// pool path and name
static const char *pool_name = "/mnt/pmem0/pmem_acceh_hash_20gb.data";
// pool size
...
int main() {
  ...
  //std::cout<<"The time used for insertion to hash table = "<<inserttime;
  ...
  //std::cout<<"The time used for duplicate insert to the hash table = "<<duplicateinserttime;
