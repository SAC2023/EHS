...
#include "allocator.h"
//#include "ex_finger.h"
#include "ACCEH/ACCEH_baseline.h"

using namespace std;
using namespace std::chrono;
// pool path and name
static const char *pool_name = "/mnt/pmem0/pmem_acceh_hash_30gb.data";
// pool size
...
int main() {
 ...
 //uto inserttime = chrono::duration_cast<chrono::microseconds>(endinsert - begininsert).count()/1000.0;
 ...
 auto inserttime = chrono::duration_cast<chrono::microseconds>(endinsert - begininsert);
  ...
  //to duplicateinserttime = chrono::duration_cast<chrono::microseconds>(endduplicateinsert - beginduplicateinsert).count()/1000.0;
  //intf("The time used for duplicate insert to the hash table = %d\n", duplicateinserttime);
  ...
  std::cout<<"\nThe time used to search items in the hash table = "<<deletetime.count()<<" microseconds." <<endl;                             
